...
public class FoodMenu {
    ...
    void createAndShowGUI() throws IOException {
        ...
        lblTotal.setBounds(519, 340, 46, 16);
        ...
        orderButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (textField.getText().equals("")) {
                    ...
                    try {
                        OrderMenu order = new OrderMenu(list);
                        order.main(header);
    ...
    void addIt(JTabbedPane tabbedPane, String text) throws IOException {
        ...
        file[0] = new String("/Icons/seafood.jpeg");
        file[1] = new String("/Icons/shrimp.jpeg");
        file[2] = new String("/Icons/sausage.jpeg");
        file[3] = new String("/Icons/margreta.jpeg");
        file[4] = new String("/Icons/meet.jpeg");
        file[5] = new String("/Icons/tuna.jpeg");
        file[6] = new String("/Icons/crispy.jpeg");
        file[7] = new String("/Icons/cheesy.jpeg");
        file[8] = new String("/Icons/chicken.jpeg");
        foodLabel[0] = new JLabel("seafood");
        foodLabel[1] = new JLabel("shrimp");
        foodLabel[2] = new JLabel("sausage");
        foodLabel[3] = new JLabel("margreta");
        foodLabel[4] = new JLabel("meet");
        foodLabel[5] = new JLabel("tuna");
        foodLabel[6] = new JLabel("crispy");
        foodLabel[7] = new JLabel("cheesy");
        foodLabel[8] = new JLabel("chicken");
        price[0] = 75.50;
        price[1] = 80.50;
        price[2] = 60.70;
        price[3] = 65.50;
...
//			Image imageScaled = image.getScaledInstance(80, 95, Image.SCALE_SMOOTH);
    ...
    void addIt2(JTabbedPane tabbedPane, String text) throws IOException {
        ...
        fileDesserts[0] = new String("/Icons/strawberry cake.jpg");
        fileDesserts[1] = new String("/Icons/chocolate cake.jpg");

        dessertLabel[0] = new JLabel("Strawberry Cake");
        dessertLabel[1] = new JLabel("Chocolate Cake");

        priceDesserts[0] = 20.50;
        priceDesserts[1] = 25.00;
    ...
    void addIt1(JTabbedPane tabbedPane, String text) throws IOException {
        ...
        fileDrinks[0] = new String("/Icons/raspberry.jpg");
        fileDrinks[1] = new String("/Icons/chocalate_pudding.jpg");
        fileDrinks[2] = new String("/Icons/blue hawailan.jpg");
        fileDrinks[3] = new String("/Icons/Pina.jpg");
        fileDrinks[4] = new String("/Icons/lemon ice.jpg");
        ...
        public void stateChanged(ChangeEvent e) {
            ...
            for (int row = 0; row < rows; row++) {
                if (dtm.getValueAt(row, 3) == e.getSource()) {
                    if (dtm.getValueAt(row, 0).equals("seafood")) {
                        dtm.setValueAt(quantity, row, 1); // obj, row, column
                        dtm.setValueAt(p1 * quantity, row, 2);
                        food1 = p1 * quantity;

                    } else if (dtm.getValueAt(row, 0).equals("shrimp")) {

                        dtm.setValueAt(quantity, row, 1);
                        dtm.setValueAt(p2 * quantity, row, 2);
                        food2 = p2 * quantity;
                    } else if (dtm.getValueAt(row, 0).equals("sausage")) {

                        dtm.setValueAt(quantity, row, 1);
                        dtm.setValueAt(p3 * quantity, row, 2);
                        food3 = p3 * quantity;
                    } else if (dtm.getValueAt(row, 0).equals("margreta")) {

                        dtm.setValueAt(quantity, row, 1);
                        dtm.setValueAt(p4 * quantity, row, 2);
                        food4 = p4 * quantity;
                    } else if (dtm.getValueAt(row, 0).equals("meet")) {

                        dtm.setValueAt(quantity, row, 1);
                        dtm.setValueAt(p5 * quantity, row, 2);
                        food5 = p5 * quantity;
                    } else if (dtm.getValueAt(row, 0).equals("tuna")) {

                        dtm.setValueAt(quantity, row, 1);
                        dtm.setValueAt(p6 * quantity, row, 2);
                        food6 = p6 * quantity;
                    } else if (dtm.getValueAt(row, 0).equals("crispy")) {

                        dtm.setValueAt(quantity, row, 1); // obj, row,
                        // column
                        dtm.setValueAt(p7 * quantity, row, 2);
                        food7 = p7 * quantity;
                    } else if (dtm.getValueAt(row, 0).equals("cheesy")) {

                        dtm.setValueAt(quantity, row, 1); // obj, row,
                        // column
                        dtm.setValueAt(p8 * quantity, row, 2);
                        food8 = p8 * quantity;
                    } else if (dtm.getValueAt(row, 0).equals("chicken")) {
